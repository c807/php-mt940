...
class Transaction implements \JsonSerializable
{
     ...
     * @param string $var
     */
    public function setReferenceAccountOwner($var)
    {
        $this->referenceAccountOwner = (string)$var;
    }
     ...
     * @return string
     */
    public function getReferenceAccountOwner()
    {
        return $this->referenceAccountOwner;
    }
